    ...
    public partial class FrmAltaSoldado : Form
    {
        ...
        private void btnReclutar_Click(object sender, EventArgs e)
        {
            if (ValidarInputSoldado())
            {
                ...
                soldadoNuevo = new Soldado(Tiempo.ConvertirFechaStringEnDateTime(txtbFechaNac.Text), Nombre.FormatearNombre(txtbNombre.Text), Nombre.FormatearNombre(txtbApellido.Text), txtbDocumento.Text, (Soldado.Rango)cmbRango.SelectedIndex, (Soldado.ClaseSoldado)Enum.Parse(typeof(Soldado.ClaseSoldado), DeterminarClase()));
