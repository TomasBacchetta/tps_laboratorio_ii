...
namespace Vista
{
    public partial class FrmModificarSoldado : Form
    {
        ...
        public FrmModificarSoldado(Cuartel cuartel, Soldado soldadoAModificar)
        {
            ...
            txtbFechaNac.Text = Tiempo.ConvertirFechaDeNacimientoAString(soldadoAModificar.FechaDeNacimiento);
        ...
        private void btnEstablecer_Click(object sender, EventArgs e)
        {
            if (ValidarInputSoldado())
            {
                ...
                soldadoAModificar.FechaDeNacimiento = Tiempo.ConvertirFechaStringEnDateTime(txtbFechaNac.Text);
        ...
        private bool ValidarInputSoldado()
        {
            ...
            if (!Numeros<int>.DeterminarSiUnStringEsNumerico(txtbDocumento.Text) || txtbDocumento.Text.Length > 15 || cuartel == soldadoAModificar)
            {
